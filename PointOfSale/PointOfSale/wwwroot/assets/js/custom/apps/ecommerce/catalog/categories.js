...
var KTAppEcommerceCategories =
    function () {
        var t, e, n = () => {
            t.querySelectorAll('[data-kt-ecommerce-category-filter="delete_row"]').
                forEach((t => {
                    t.addEventListener("click", (function (t) {
                        ...
                        Swal.fire({
                            ...
                            if (t.value) {
                                $.post('/Category/Delete', { id: o }, function (res) {
                                    if (res.status) {
                                        Swal.fire({
            ...
            init: function () {
                (t = document.querySelector("#kt_ecommerce_category_table")) && ((e = $(t).DataTable({
                    ...
                    "columns": [
                        ...
                        {
                            "data": null,
                            "defaultContent": `<button class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm" onclick="KTAppEcommerceCategories.getId(this)">
                        ...
                        <button class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm" data-kt-ecommerce-category-filter="delete_row">
                        <span class="svg-icon svg-icon-3">
																				<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
