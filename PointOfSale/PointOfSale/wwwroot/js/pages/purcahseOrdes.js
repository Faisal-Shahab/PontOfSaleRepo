            ...
            init: function () {
                ...
                (t = document.querySelector("#kt_ecommerce_purchase_table")) && ((e = $(t).DataTable({
                    ...
                    "columns": [
                        ...
                        { data: "balance", "sortable": false, "className": "text-end pe-0" },
                ...
                $('#kt_ecommerce_purchase_table').off().on("click", "button.details-control", function () {
                    ...
                    if (row.child.isShown()) {
                        ...
                        var childTable = $('#in' + id).DataTable({
                            "bServerSide": false,
                            ajax: {
                                "url": '/Order/GetPurchaseOrderDetail',
                                "type": "POST",
                                "data": {
                                    id: id,
                                }
...
function getId(ele) {
    ...
    $.post('/order/GetPurchaseOrderInvoiceDetails', { id: id }, function (response) {
