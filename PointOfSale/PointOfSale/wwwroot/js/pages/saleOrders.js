                ...
                (t = document.querySelector("#kt_ecommerce_sales_table")) && ((e = $(t).DataTable({
                    ...
                    "columns": [
                        ...
                        <span class="svg-icon svg-icon-3">
                                                    ...
                                                    <button class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm" onclick="KTAppEcommerceCategories.printInvoice()">
                                                               <span class="svg-icon svg-icon-3">
																				<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
																					<path d="M5 9C5 8.44772 5.44772 8 6 8H18C18.5523 8 19 8.44772 19 9V18C19 19.6569 17.6569 21 16 21H8C6.34315 21 5 19.6569 5 18V9Z" fill="currentColor"></path>
																					<path opacity="0.5" d="M5 5C5 4.44772 5.44772 4 6 4H18C18.5523 4 19 4.44772 19 5V5C19 5.55228 18.5523 6 18 6H6C5.44772 6 5 5.55228 5 5V5Z" fill="currentColor"></path>
...
KTUtil.onDOMContentLoaded((function () {
    ...
    //customerName,customerEmail,companyReg,taxNo,companyLogo,orderId,invNum,invDate,itemsList,grandTotal
}));